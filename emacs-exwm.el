...
(setq reftex-label-alist
   '(("lemma" ?L "lem:"  "~\\ref{%s}" nil ("lemma" "le."))
     ...
     ("remark" ?R "rem" "~\\ref{%s}" t ("remark" "rem." "re."))
     ("definition" ?D "def" "~\\ref{%s}" t ("definition" "def." "de."))
     ("example" ?E "exa" "~\\ref{%s}" t ("example" "exa." "ex."))
     ))
...
;;; font setting
;(set-frame-font "-ADBO-Source Code Pro-normal-normal-normal-*-30-*-*-*-m-0-iso10646-1")
;(set-frame-font "-PfEd-agave Nerd Font Mono-normal-normal-normal-*-30-*-*-*-m-0-iso10646-1")
